...
class Polygon():
    ...
    def __init__(self):
        ...
        self.nverts = random.randint(3, 8) # number of verticesthis _does_ include final 8
    ...
    def show_perimeter(self, ax=None):
        """Draw, emphasizing the polygon's perimeter"""
        import matplotlib as mpl
        ...
        ax.plot([X[-1], X[0]], [Y[-1], Y[0]], color=poly_color, linewidth=2, zorder=1)

        # draw vertices
        ax.scatter(X, Y, color='lightgray', marker='s', zorder=2)
